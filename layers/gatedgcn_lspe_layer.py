...
class GatedGCNLSPELayer(nn.Module):
    """
        Param: []
    """
    def __init__(self, input_dim, output_dim, dropout, batch_norm, residual=False, activation=None):
        super().__init__()
    ...
    def forward(self, g, h, e, p, d=None):   
    ...
    def __repr__(self):
        return '{}(in_channels={}, out_channels={}, batch_norm={}, residual={}, dropout={})'.format(self.__class__.__name__,
                                             self.in_channels,
                                             self.out_channels,
                                             self.batch_norm,
                                             self.residual,
