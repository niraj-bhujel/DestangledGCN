...
# -*- coding: utf-8 -*-
"""
Created on Wed May 11 09:55:50 2022
...
def cluster_traj(k: int, traj: torch.Tensor, device):
    ...
    traj_summed = torch.zeros(batch_size, k, traj_len, 2, device=device, dtype=traj.dtype).scatter_add(1, lbls, traj)
    ...
    return traj_clustered.permute(1, 0, 2, 3), scores.permute(1, 0)